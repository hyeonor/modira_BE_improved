...
public enum ErrorCode {
    ...
    NICKNAME_DUPLICATION_CODE(BAD_REQUEST, "C001", "중복된 닉네임이 있습니다"),
    ...
    JOIN_CHATROOM_CHECK_CODE(BAD_REQUEST, "C009", "참여중인 모임이 있습니다."),
    JOIN_AGE_CHECK_CODE(BAD_REQUEST, "C010", "나이 조건이 맞지 않습니다."),
    JOIN_GENDER_CHECK_CODE(BAD_REQUEST, "C011", "성별 조건이 맞지 않습니다.");
    ...
    ErrorCode(HttpStatus status, String code, String message) { //enum 은 생성자가 존재하지만 Default 생성자는 private 로 되어 있으며 public 으로 변경하는 경우 컴파일 에러가 발생
